...
class RegisterScreen(BackgroundWidget):
    ...
    def do_register(self):
        ...
        # логин — только латинские буквы, цифры и символы
        for c in username:
        ...
        # пароль — не короче 6 символов и не больше 20, без пробелов,
        # содержит хотя бы одну букву и хотя бы одну цифру, без кириллицы
        if len(password) < 6 or len(password) > 20:
            QMessageBox.warning(self, "Регистрация",
                                "Пароль должен быть не короче 6 и не больше 20 символов.")
            return
